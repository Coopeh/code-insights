...
i just synced latest - and it added many ---CONVERSATION User--- messages we saw earlier back into the sessions list.. check sqlite db and investigate
...
commit, push to master and release patch
